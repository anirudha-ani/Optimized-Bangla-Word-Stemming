#Trie library Taken from - https://nickstanisha.github.io/2015/11/21/a-good-trie-implementation-in-python.html
...
#######################################################################################################
#################### CODE OF ANIRUDHA STARTS FROM HERE ################################################
#######################################################################################################
...
with open('BanglaWordList.csv', 'r', encoding="utf8") as csvfile:
...
##### Preparing the TRIE TREE AND Inserting every possible substring of the dictionary words in the trie ########
##### This is a one time pre processing #####
trie = Trie()
for i in banglaWordlist:
    ...
    for j in range(1, length+1):
        for k in range(0,j):
            trie.add(i[k:j])
print("Dictionary Inserted Into Trie Complete")


###### This function takes a string and generate all possible substring substring and try to find match in the already built trie
...
print(stemBanglaWord("বাংলাদেশকে"))
print(stemBanglaWord("বাংলাদেশের"))
print(stemBanglaWord("বাংলাকে"))
